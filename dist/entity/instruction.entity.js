...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 20, nullable: true, comment: '指令名称' }),
    __metadata("design:type", String)
], Instruction.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 50, nullable: true, comment: '版本' }),
    __metadata("design:type", String)
], Instruction.prototype, "version", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 50, nullable: true, comment: '触发方式' }),
    __metadata("design:type", String)
], Instruction.prototype, "trigger_mode", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.CreateDateColumn)({ type: 'timestamp', precision: 6, default: () => 'CURRENT_TIMESTAMP(6)', comment: '失效时间' }),
    __metadata("design:type", Date)
], Instruction.prototype, "expire_at", void 0);
__decorate([
